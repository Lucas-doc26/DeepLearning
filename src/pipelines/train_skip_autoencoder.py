...
if __name__ == "__main__":  
    ...
    df_train = pd.read_csv(f'/home/c.oliveira25/Desktop/DeepLearning/CSV/{args.train}/{args.train}_train.csv')
    train = preprocess_dataset(df_train, batch_size=32, autoencoder=True, transform=salt_and_pepper(), prob=1)

    df_valid = pd.read_csv(f'/home/c.oliveira25/Desktop/DeepLearning/CSV/{args.train}/{args.train}_valid.csv')
    valid = preprocess_dataset(df_valid, batch_size=32, autoencoder=True)

    df_test = pd.read_csv(f'/home/c.oliveira25/Desktop/DeepLearning/CSV/{args.train}/{args.train}_test.csv')
    ...
    model.save_model('/home/c.oliveira25/Desktop/DeepLearning/models/skip_autoencoder/', 'skip_autoencoder')
    model.save_weights('/home/c.oliveira25/Desktop/DeepLearning/models/skip_autoencoder/weights', 'skip_autoencoder', f'{args.train}') 

    plot_autoencoder_with_ssim(test, model,
                               save_path=f'/home/c.oliveira25/Desktop/DeepLearning/models/skip_autoencoder/plots/autoencoder_reconstruction/skip_autoencoder_{args.train}.png')
    ...
    save_autoencoder_log(
        log_dir='/home/c.oliveira25/Desktop/DeepLearning/models/skip_autoencoder/logs',
