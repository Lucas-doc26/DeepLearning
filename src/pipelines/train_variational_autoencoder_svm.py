...
from models import VariationalAutoencoderSVM, classifier_log
...
if __name__ == "__main__":  
    ...
    model = VariationalAutoencoderSVM(
        '/home/lucas/DeepLearning/models/variational_autoencoder/variational_autoencoder.keras',
        f'/home/lucas/DeepLearning/models/variational_autoencoder/weights/variational_autoencoder-{args.autoencoder}.weights.h5'
    )   
    ...
    for dataset_test in args.test:
        ...
        cm_path = f'/home/lucas/DeepLearning/models/variational_autoencoder/plots/confusion_matrix/{args.autoencoder}/{args.train}/SVM/{args.autoencoder}-{args.train}-{dataset_test}.png'
    ...
    classifier_log(log_dir=log_dir, model_name='variational_autoencoder_SVM', 
